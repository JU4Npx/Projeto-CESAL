    ...
    while True:
        ...
        try:
            ...
            if ID_busca == '0':
                ...
                while True:
                    print("")
                    print(f"Professor selecionado: {professor[1]} (ID {professor[0]})")
                    ...
                    try:
                        ...
                        if opcao == 4:
                            while True:
                                try:
                                    novo_telefone = input("Por favor, digite o telefone do professor(com '55' + DDD e os números sem espaço): ")
                                    if len(novo_telefone) != 13:
